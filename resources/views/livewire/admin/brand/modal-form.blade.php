<div wire:ignore.self class="modal fade" id="addBrandModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select wire:model.defer="category_id" required class="form-control">
                            ...
                            @foreach ($categories as $cartItem)
                            <option value="{{$cartItem->id}}">{{$cartItem->name}}</option>
                            @endforeach
                        </select>
...
<div wire:ignore.self class="modal fade" id="deleteBrandModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
