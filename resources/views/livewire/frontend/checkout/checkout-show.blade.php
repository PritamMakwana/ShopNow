                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="d-md-flex align-items-start">
                                    <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link fw-bold active" wire:loading.attr='disabled' id="cashOnDeliveryTab-tab"
                                            ...
                                            Delivery</button>
                                        <button class="nav-link fw-bold" wire:loading.attr='disabled' id="onlinePayment-tab" data-bs-toggle="pill"
